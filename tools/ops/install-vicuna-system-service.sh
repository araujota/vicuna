...
VICUNA_DEEPSEEK_MODEL=${VICUNA_DEEPSEEK_MODEL:-deepseek-chat}
...
VICUNA_OPENCLAW_TOOL_FABRIC_SECRETS_PATH=${VICUNA_OPENCLAW_TOOL_FABRIC_SECRETS_PATH:-$ETC_DIR/openclaw-tool-secrets.json}
VICUNA_OPENCLAW_TOOL_FABRIC_CATALOG_PATH=${VICUNA_OPENCLAW_TOOL_FABRIC_CATALOG_PATH:-$STATE_ROOT/openclaw-catalog.json}
VICUNA_OPENCLAW_NODE_BIN=${VICUNA_OPENCLAW_NODE_BIN:-$node_bin}
TAVILY_API_KEY=${TAVILY_API_KEY:-}
RADARR_API_KEY=${RADARR_API_KEY:-}
RADARR_BASE_URL=${RADARR_BASE_URL:-http://10.0.0.218:7878}
SONARR_API_KEY=${SONARR_API_KEY:-}
SONARR_BASE_URL=${SONARR_BASE_URL:-http://10.0.0.218:8989}
CHAPTARR_API_KEY=${CHAPTARR_API_KEY:-}
CHAPTARR_BASE_URL=${CHAPTARR_BASE_URL:-http://10.0.0.218:8789}
SUPERMEMORY_API_KEY=${SUPERMEMORY_API_KEY:-}
SUPERMEMORY_BASE_URL=${SUPERMEMORY_BASE_URL:-https://api.supermemory.ai}
