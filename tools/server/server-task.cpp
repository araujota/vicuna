...
json server_task_result_metrics::to_json() {
    return json {
        ...
        { "waiting_active_tasks",            n_waiting_active_tasks },
        { "external_bash_pending",           n_external_bash_pending },
        { "external_hard_memory_pending",    n_external_hard_memory_pending },
        { "proactive_responses",             n_proactive_responses },
        { "proactive_live_events",           n_proactive_live_events },
        { "proactive_live_stream_connected", proactive_live_stream_connected },
        { "proactive_last_publish_ms",       proactive_last_publish_ms },
        { "t_start",                         t_start },
        { "runtime_persistence_enabled",     runtime_persistence_enabled },
        { "runtime_persistence_healthy",     runtime_persistence_healthy },
        { "runtime_restore_attempted",       runtime_restore_attempted },
        { "runtime_restore_success",         runtime_restore_success },
        { "runtime_last_persist_ms",         runtime_last_persist_ms },
        { "runtime_last_restore_ms",         runtime_last_restore_ms },
        { "provenance_enabled",              provenance_enabled },
        { "provenance_healthy",              provenance_healthy },
        { "provenance_last_append_ms",       provenance_last_append_ms },
        ...
        { "n_external_bash_dispatch_total",  n_external_bash_dispatch_total },
        { "n_external_bash_complete_total",  n_external_bash_complete_total },
        { "n_external_bash_fail_total",      n_external_bash_fail_total },
        { "n_external_hard_memory_dispatch_total", n_external_hard_memory_dispatch_total },
        { "n_external_hard_memory_complete_total", n_external_hard_memory_complete_total },
        { "n_external_hard_memory_fail_total", n_external_hard_memory_fail_total },
        { "proactive_publish_total",         proactive_publish_total },
        { "proactive_complete_total",        proactive_complete_total },
        { "proactive_fail_total",            proactive_fail_total },
        { "proactive_dropped_total",         proactive_dropped_total },
        { "runtime_persist_success_total",   runtime_persist_success_total },
        { "runtime_persist_fail_total",      runtime_persist_fail_total },
        { "provenance_append_total",         provenance_append_total },
        { "provenance_append_fail_total",    provenance_append_fail_total },
        { "provenance_active_loop_total",    provenance_active_loop_total },
        { "provenance_tool_result_total",    provenance_tool_result_total },
        { "provenance_dmn_total",            provenance_dmn_total },
        { "provenance_discovered_increase_total", provenance_discovered_increase_total },
        { "provenance_permanent_increase_total", provenance_permanent_increase_total },
        { "provenance_allostatic_increase_total", provenance_allostatic_increase_total },
        { "provenance_functional_update_total", provenance_functional_update_total },
        { "provenance_process_update_total", provenance_process_update_total },
        { "provenance_self_state_active_count", provenance_self_state_active_count },
        { "provenance_self_state_discovered_count", provenance_self_state_discovered_count },
        { "provenance_self_state_permanent_count", provenance_self_state_permanent_count },
        { "provenance_self_state_allostatic_count", provenance_self_state_allostatic_count },
        { "provenance_self_state_allostatic_divergence", provenance_self_state_allostatic_divergence },
        { "provenance_self_state_promotion_readiness", provenance_self_state_promotion_readiness },
        { "provenance_self_state_belief_pressure", provenance_self_state_belief_pressure },
