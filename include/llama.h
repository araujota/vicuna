...
#    define LLAMA_CPP_MEMBER_INIT(value)
    ...
    enum {
        ...
        LLAMA_BASH_TOOL_MAX_PENDING_REQUESTS = 16,
    };
    ...
    LLAMA_API int32_t llama_bash_tool_get_request(
            const struct llama_context * ctx,
            int32_t command_id,
            struct llama_bash_tool_request * out_request);
    LLAMA_API int32_t llama_bash_tool_set_request(
            struct llama_context * ctx,
            const struct llama_bash_tool_request * request);
    LLAMA_API int32_t llama_bash_tool_submit_result(
            struct llama_context * ctx,
